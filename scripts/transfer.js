...
async function main() {
  ...
  const contractFactory = await hre.ethers.getContractFactory("ERC20Test");
  ...
  console.log(
    ...
    `Sent transaction hash: https://explorer-evm.testnet.swisstronik.com/tx/${transaction.hash}`
  );
}
